...
class Base(object):
    def retorna_base_emocoes(self):
        return [('este trabalho e agradável','alegria'),
                ...
                ('vão me matar!', 'medo'),
                ('querem me matar!', 'medo'),
                ('estão aqui para me matar!', 'medo'),
                ('tenho medo de morrer!', 'medo'),
                ('acho que vou morrer!', 'medo'),
                ('acho que vou morrer agora!', 'medo'),
                ('não gosto da ideia de morrer!', 'medo'),
                ('não gosto de ficar só!', 'medo'),
                ('não gosto de ficar sozinha!', 'medo'),
                ...
                ('abra meu facebook','neutro'),        
                ('abrir facebook','neutro'),
                ('abrir página do facebook','neutro'),
                ('rodar facebook','neutro'),
                ('executar facebook','neutro'),
                ('facebook','neutro'),
                ('abra meu face','neutro'),        
                ('abrir face','neutro'),
                ('face','neutro'),

                ('ir para a pagina inicial do facebook','neutro'),
                ('pagina inicial do facebook','neutro'),
                ('feed de noticias do facebook','neutro'),
                ('linha do tempo do facebook agora','neutro'),
                ('mostrar linha do tempo do facebook','neutro'),
                ('abrir linha do tempo do facebook','neutro'),
                ('abrir minha linha do tempo do facebook','neutro'),        
                ('abrir meu feed de noticias do facebook','neutro'),


                ('abra meu github','neutro'),                                     
                ('rodar github','neutro'),                
                ('github','neutro'),                       
                ('abrir git','neutro'),
                ('git','neutro'),

                ('abra meu youtube','neutro'),
                ('rodar youtube','neutro'),
                ('executar youtube','neutro'),        
                ('youtube','neutro'),                

                ('buscar o sinonimo de','neutro'),
                ('sinonimo de ','neutro'),
                ('quero saber o sinonimo de ','neutro'),                
                ('qual o sinonimo da palavra','neutro'),                
                
                ('antonimo de ','neutro'),
                ('quero saber o antonimo de ','neutro'),                
                ('qual o antonimo da palavra','neutro'),
                ('antonimo da palavra','neutro'),

                ('buscar o significado de','neutro'),
                ('significado de ','neutro'),
                ('quero saber o significado de ','neutro'),               
                ('qual o significado da palavra','neutro'),                

                ('buscar a tarducaoo de','neutro'),
                ('traduzir','neutro'),                
                ('qual a traducao de','neutro'),
                ('o que significa em ingles','neutro'),                
                ('traduza para mim','neutro'),                         

                ('abrir navegador','neutro'),
                ('rodar navegador','neutro'),                
                ('abrir meu navegador de internet','neutro'),
                ('acessar internet','neutro'),
                ('usar internet','neutro'),

                ('qual a previsao do tempo','neutro'),
                ('qual a previsao do tempo para hoje','neutro'),                
                ('me fale sobre a previsão do tempo ','neutro'),
                ('vai chover hoje','neutro'),
                ('vai fazer sol','neutro'),                                               

                ('quantas horas são','neutro'),
                ('que horas são','neutro'),
                ('horas','neutro'),
                ('que hora é agora','neutro'),
                ('horário atual','neutro'),
                ('horas por favor','neutro'),
                ('horas e minutos','neutro'),
                ('horas','neutro'),
                ('minutos','neutro'),
                
                ('aumentar volume','neutro'),
                ('aumentar som','neutro'),
                ('aumentar volume do som','neutro'),
                ('aumentar audio','neutro'),
                ('aumentar audio volume','neutro'),                                
                ('subir volume','neutro'),
                ('elevar o  som','neutro'),
                ('elevar volume do som','neutro'),                

                ('diminuir volume','neutro'),
                ('diminuir som','neutro'),
                ('diminuir volume do som','neutro'),
                ('diminuir audio','neutro'),
                ('diminuir audio volume','neutro'),
                ('descer volume','neutro'),
                ('abaixar som','neutro'),
                ('abaixar volume do som','neutro'),
                ('abaixar audio','neutro'),
                ('abaixar audio volume','neutro'),
                
                ('tocar musica','neutro'),
                ('tocar musicas','neutro'),
                ('quero escutar musicas','neutro'),
                ('escutar musicas','neutro'),
                
                ('pesquise por','neutro'),
                ('pesquise no google','neutro'),
                ('pesquisar por','neutro'),
                ('pesquise sobre','neutro'),
                ('pesquise na internet','neutro'),
                ('pesquise na internet sobre','neutro'),
                ('busque','neutro'),
                ('busque no google','neutro'),
                ('busque na internet','neutro'),         
                ('pesquisar','neutro'),

                ('Conte-me uma piada', 'neutro'),
                ('Quero ouvir uma piada', 'neutro'),
                ('Conta uma piada', 'neutro'),
                ('Conta uma história', 'neutro'),
                ('Conte algo engracado', 'neutro'),
                ('Diga algo engraçado', 'neutro'),
                ('Me conta uma piada', 'neutro'),
                ('Conte-me uma piada', 'neutro'),

                ('desligar lampada', 'neutro'),
                ('desligar a lampada', 'neutro'),
                ('desliga a lampada', 'neutro'),
                ('apagar lampada', 'neutro'),
                ('apagar a lampada', 'neutro'),
                ('apagar luz', 'neutro'),
                ('apagar a luz', 'neutro'),
                ('apaga a luz', 'neutro'),

                ('ligar lampada', 'neutro'),
                ('ligar a lampada', 'neutro'),
                ('acender lampada', 'neutro'),
                ('acender a lampada', 'neutro'),
                ('ligar a lampada', 'neutro'),
                ('acender a luz', 'neutro'),
                ('acende a luz', 'neutro'),
                ('acender luz', 'neutro'),
                ('lampada ligar', 'neutro')]
